data "template_file" "swagger" {
  ...
  vars = {
    ...
    LAMBDA_SIGNIN_FUNCTION_ARN        = "${var.LAMBDA_SIGNIN_FUNCTION_ARN}"
    LAMBDA_SIGNUP_FUNCTION_ARN        = "${var.LAMBDA_SIGNUP_FUNCTION_ARN}"
  ...
  #  LAMBDA_LOGIN_FUNCTION_ARN           = "${var.LAMBDA_LOGIN_FUNCTION_ARN}"
    ...
    LAMBDA_PUT_CONFIRM_FORGOT_PASSWORD_FUNCTION_ARN = "${var.LAMBDA_PUT_CONFIRM_FORGOT_PASSWORD_FUNCTION_ARN}"
