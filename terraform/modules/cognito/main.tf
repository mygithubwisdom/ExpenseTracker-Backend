...
resource "aws_cognito_user_pool" "congito_end_user_userpool" {
  ...
  verification_message_template {
    ...
    email_message         = "Hello {custom:first_name}, Welcome, your journey starts here! Your Verification Code is: {####} If you need any assistance please contact us at support@TrackAm.com. We are here to assist. Regards, TrackAm Team"
    email_message_by_link = "Hello,<br/><br/>Your Account has been created ${var.RESOURCE_PREFIX} on the TrackAm platform.<br/><br/>Please click the link below to verify your email address on the platform. {##Verify Email##}<br/><br/> You will receive a separate email address with your login details<br/><br/>We are happy to have you as a part of TrackAm Family<br/><br/>"
    email_subject         = "[TrackAm] Registration Email Verification"
    email_subject_by_link = "Welcome to TrackAm"
    sms_message           = "Your TrackAm ${var.RESOURCE_PREFIX} reset password code is {####}"
  }
